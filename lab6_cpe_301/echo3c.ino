/*
  ...
  Date: 10/20/25
  Description: This program reads from the serial port, and repeats inputs into the serial monitor as hex. 
  This was built off the provided example and echo2c.ino.
*/
...
void loop()
{
  ...
  U0putchar('0');
  U0putchar('x');
  U0putchar(bitsToHex((cs1 >> 4) & 0x0F)); // echo hex (takes 4 bits at a time)
  U0putchar(bitsToHex(cs1 & 0x0F)); // echo hex
  U0putchar('\n');     
}
